...
<div class='title row'>
	...
	<div class="col-md-10 ">
		...
		<h2 class="title-div"><?= Html::encode($this->title) ?></h2><div class="mpi-indicator" title="This software uses OpenMPI">OpenMPI&nbsp;<i class="fa fa-rocket" aria-hidden="true"></i></div>

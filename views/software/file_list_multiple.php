...
echo Html::cssFile('@web/css/software/select-file.css');
...
$this->registerJsFile('@web/js/software/select-file-multiple.js', ['depends' => [\yii\web\JqueryAsset::className()]] );
...
<div class="wrap">
    <div class="container">
       <br /><!--these line breaks are required, or else the content will not be complente on the popup-->
		...
		<br />
		<?=FileListSoftware::printFileList($files,0,$root)?>

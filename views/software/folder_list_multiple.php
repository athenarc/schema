...
echo Html::cssFile('@web/css/software/select-folder.css');
...
$this->registerJsFile('@web/js/software/select-folder-multiple.js', ['depends' => [\yii\web\JqueryAsset::className()]] );

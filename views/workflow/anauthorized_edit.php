...
<div class="alert alert-danger" role="alert">
	<div class='row'><div class='text-center col-md-12'><h3>Error: workflow "<?=$name?> v.<?=$version?>" does not exist or you are not authorized to edit its metadata.</h3></div></div>
</div>
